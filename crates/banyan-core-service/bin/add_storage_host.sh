...
INSERT INTO storage_hosts (name, url, used_storage, available_storage, continent, fingerprint, pem)
  VALUES ('banyan-staging', 'http://127.0.0.1:3002/', 0, 549755813888000, 'North America', ${STORAGE_HOST_FINGERPRINT}', '${STORAGE_HOST_PUBKEY}')
  RETURNING id;
EOSQL
