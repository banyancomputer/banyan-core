...
mod tests {
    ...
    use crate::api::buckets::bucket_configuration::handler;
    use crate::api::models::ApiBucketConfiguration;
    ...
    async fn test_bucket_configuration_update() {
        ...
        let new_config = ApiBucketConfiguration {
            ...
            replicas: Some(3),
            bucket_type: Some(BucketType::Backup),
        ...
        assert_eq!(updated_bucket.r#type, new_config.bucket_type.unwrap());
        assert_eq!(
            updated_bucket.storage_class,
            new_config.storage_class.unwrap()
        );
    }
}
