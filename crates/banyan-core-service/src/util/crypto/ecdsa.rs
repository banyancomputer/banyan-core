...
mod tests {
    ...
    fn test_key_lifecycle() {
        ...
        let encoded_private_key = encode_private_key(&private_key).expect("private key encoding to succeed");
        let _decoded_private_key = decode_private_key(&encoded_private_key.as_ref()).expect("private key decoding to succeed");
