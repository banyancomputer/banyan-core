import { HashAlg, SymmKeyOpts, SymmKey } from '../types';
/**
 ...
 */
export declare function deriveKey(ikm: ArrayBuffer, salt: ArrayBuffer, infoStr?: string, hashAlg?: HashAlg, uses?: KeyUsage[], opts?: Partial<SymmKeyOpts>): Promise<SymmKey>;
