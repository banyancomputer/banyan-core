...
import { SymmAlg, ExportKeyFormat, } from '../types.js';
import { InvalidIvLength, InvalidCipherTextLength, UnsupportedSymmCrypto, } from '../errors.js';
/**
 ...
 */
export async function encryptBytes(msg, key, opts) {
 ...
 */
export async function decryptBytes(msg, key, opts) {
 ...
 * @throws InvalidCipherTextLength
 */
export async function encrypt(msg, key, opts) {
 ...
 * @throws InvalidCipherTextLength
 */
export async function decrypt(msg, key, opts) {
 ...
 */
export async function wrapKey(key, wrappingKey) {
    return await webcrypto.subtle.wrapKey(ExportKeyFormat.RAW, key, wrappingKey, 'AES-KW');
}
/**
 ...
 */
export async function unwrapKey(wrappedKey, unwrappingKey, unwrappedKeyAlgParams, extractable, keyUsages) {
    return await webcrypto.subtle.unwrapKey(ExportKeyFormat.RAW, wrappedKey, unwrappingKey, 'AES-KW', unwrappedKeyAlgParams, extractable, keyUsages);
}
export default {
    encryptBytes,
    decryptBytes,
