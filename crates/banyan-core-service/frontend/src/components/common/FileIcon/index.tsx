...
import {
    AiOutlineFilePdf, AiOutlineFileGif, AiOutlineFileText,
    AiOutlineFileWord, AiOutlineFilePpt, AiOutlineFileJpg,
    AiOutlineFileImage, AiOutlineFileZip, AiOutlineFile,
    AiOutlineFileExcel
} from "react-icons/ai";
