    ...
    return (
        <div className="flex relative flex-grow max-w-xl">
            ...
            {search &&
                <>
                    <span
                        className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-500 bg-border h-fit rounded-full cursor-pointer"
                        onClick={clearSearch}
                    >
                        <IoMdClose size="20px" />
                    </span>
                    <div
                        className="absolute top-11 left-0 w-full max-h-48 flex flex-col items-stretch z-10 bg-mainBackground rounded-lg shadow-md overflow-y-scroll"
                    >
