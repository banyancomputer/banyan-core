export default {
    coponents : {
        ...
        common: {
            ...
            bucketActions: {
                upload: "Upload",
                takeArchivalSnapshot: "Take a archival snapshot",
                viewArchivalSnapshots: "View archival snapshots",
            ...
            modal: {
                ...
                takeSnapshot: {
                    title: "Take a archival snapshot",
                    subtitle: "Do you want to take a archival snapshot",
                    cancel: "Cancel",
                    takeArchivalSnapshot: "Take a archival snapshot",
