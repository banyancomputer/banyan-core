...
export const Lock = (params: SVGProps<any>) => <svg fill="currentColor" height="24px" width="24px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 330 330" {...params}>
    <g id="XMLID_486_">
