...
export function wasm_bindgen__convert__closures__invoke1_mut__h7bdc23e9fbd0a5c4(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke1_mut__hee4c82fc6940d309(a: number, b: number, c: number): void;
export function __wbindgen_add_to_stack_pointer(a: number): number;
export function __wbindgen_free(a: number, b: number, c: number): void;
export function __wbindgen_exn_store(a: number): void;
export function wasm_bindgen__convert__closures__invoke2_mut__h35e9cdf62e1d3c91(a: number, b: number, c: number, d: number): void;
