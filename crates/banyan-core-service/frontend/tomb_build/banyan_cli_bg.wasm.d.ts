...
export function wasm_bindgen__convert__closures__invoke1_mut__h0911221442074ba5(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke1_mut__h8ae7bee3bbde1866(a: number, b: number, c: number): void;
export function __wbindgen_add_to_stack_pointer(a: number): number;
export function __wbindgen_free(a: number, b: number, c: number): void;
export function __wbindgen_exn_store(a: number): void;
export function wasm_bindgen__convert__closures__invoke2_mut__h1a1b88877898d37b(a: number, b: number, c: number, d: number): void;
