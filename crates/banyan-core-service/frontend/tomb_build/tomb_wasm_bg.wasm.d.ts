...
export function wasm_bindgen__convert__closures__invoke1_mut__heefcbb8a797a1908(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke1_mut__h3c0edbbc0a89e76a(a: number, b: number, c: number): void;
export function __wbindgen_add_to_stack_pointer(a: number): number;
export function __wbindgen_free(a: number, b: number, c: number): void;
export function __wbindgen_exn_store(a: number): void;
export function wasm_bindgen__convert__closures__invoke2_mut__ha549d512bd5316ee(a: number, b: number, c: number, d: number): void;
