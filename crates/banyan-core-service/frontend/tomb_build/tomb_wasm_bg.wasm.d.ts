...
export function wasm_bindgen__convert__closures__invoke1_mut__hf2327e9ee8a1525c(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke1_mut__haa0698c19b84fc36(a: number, b: number, c: number): void;
export function __wbindgen_add_to_stack_pointer(a: number): number;
export function __wbindgen_free(a: number, b: number, c: number): void;
export function __wbindgen_exn_store(a: number): void;
export function wasm_bindgen__convert__closures__invoke2_mut__h72a6c61b9db808f0(a: number, b: number, c: number, d: number): void;
