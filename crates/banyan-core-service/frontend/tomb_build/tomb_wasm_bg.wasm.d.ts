...
export function wasm_bindgen__convert__closures__invoke1_mut__h97945678726110b7(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke1_mut__hcdb1b3e91dfda87d(a: number, b: number, c: number): void;
export function __wbindgen_add_to_stack_pointer(a: number): number;
export function __wbindgen_free(a: number, b: number, c: number): void;
export function __wbindgen_exn_store(a: number): void;
export function wasm_bindgen__convert__closures__invoke2_mut__h05eb326171c444e4(a: number, b: number, c: number, d: number): void;
